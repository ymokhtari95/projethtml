...
<section class="card">
    ...
    <hr style="margin:20px 0;border:none;border-top:1px solid #1f2937;">

    <h3>Description</h3>
    <p><?= nl2br(htmlspecialchars($event['description'])) ?></p>

    <!-- Zone d'actions (inscription / désinscription / login) -->
    ...
    <?php if (
        ...
        <hr style="margin:25px 0;border:none;border-top:1px solid #1f2937;">
